...
public class GameTreeTest {
	...
	// initialization. This allows you to ALWAYS begin with the same exact questions
	// and answers.. Instead of @Test, this is @BeforeClass
	//
	@BeforeClass
	...
	@BeforeClass
	public static void testEmptyFile() throws FileNotFoundException {
		// Let outfile be an object like System.out. You can send println messages to
		// outfile
		PrintWriter outFile = new PrintWriter(new FileOutputStream("t2UofATEST1.txt"));
		GameTree aGame = new GameTree("t2UofATEST1.txt");
		assertEquals(null, aGame.getCurrent());
		outFile.close(); // Make sure you close() the file
	}
